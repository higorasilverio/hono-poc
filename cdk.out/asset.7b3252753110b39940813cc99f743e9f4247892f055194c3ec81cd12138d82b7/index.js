...
// asset-input/node_modules/hono/dist/utils/url.js
var splitPath = (path) => {
...
// asset-input/node_modules/hono/dist/utils/cookie.js
...
// asset-input/node_modules/hono/dist/utils/html.js
...
// asset-input/node_modules/hono/dist/utils/stream.js
...
// asset-input/node_modules/hono/dist/context.js
...
// asset-input/node_modules/hono/dist/compose.js
...
// asset-input/node_modules/hono/dist/http-exception.js
...
// asset-input/node_modules/hono/dist/utils/body.js
...
// asset-input/node_modules/hono/dist/request.js
...
// asset-input/node_modules/hono/dist/router.js
...
// asset-input/node_modules/hono/dist/hono-base.js
    ...
    this.on = (method, path, ...handlers) => {
      ...
      for (const m of [method].flat()) {
        handlers.map((handler2) => {
          this.addRoute(m.toUpperCase(), __privateGet3(this, _path), handler2);
        });
      }
      return this;
    };
...
// asset-input/node_modules/hono/dist/router/reg-exp-router/node.js
...
// asset-input/node_modules/hono/dist/router/reg-exp-router/trie.js
var Trie = class {
  constructor() {
...
// asset-input/node_modules/hono/dist/router/reg-exp-router/router.js
...
// asset-input/node_modules/hono/dist/router/smart-router/router.js
...
// asset-input/node_modules/hono/dist/router/trie-router/node.js
var Node2 = class {
...
// asset-input/node_modules/hono/dist/router/trie-router/router.js
...
// asset-input/node_modules/hono/dist/hono.js
...
// asset-input/node_modules/hono/dist/adapter/aws-lambda/handler.js
var import_crypto = __toESM(require("crypto"), 1);

// asset-input/node_modules/hono/dist/utils/encode.js
...
app.post("/items", async (c) => {
  ...
  await db.send(new import_lib_dynamodb.PutCommand({ TableName: tableName, Item: item }));
  return c.json(item, 201);
});
app.get("/items", async (c) => {
  const result = await db.send(new import_lib_dynamodb.ScanCommand({ TableName: tableName }));
  return c.json(result.Items ?? []);
});
app.get("/items/:id", async (c) => {
  const id = c.req.param("id");
  const result = await db.send(new import_lib_dynamodb.GetCommand({ TableName: tableName, Key: { id } }));
...
app.delete("/items/:id", async (c) => {
  const id = c.req.param("id");
  await db.send(new import_lib_dynamodb.DeleteCommand({ TableName: tableName, Key: { id } }));
